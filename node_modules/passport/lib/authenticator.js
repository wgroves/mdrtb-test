 ...
 *
 *     app.get('/auth/twit', passport.authenticate('twit'), function(req, res) {
 *       // request will be redirected to Twit
 *     });
 *     app.get('/auth/twit/callback', passport.authenticate('twit'), function(req, res) {
 *       res.json(req.user);
 *     });
 *
 ...
 * Examples:
 *
 *    passport.authorize('twit-authz', { failureRedirect: '/account' });
 *
 * @param {String} strategy
 * @param {Object} options
 * @return {Function} middleware
